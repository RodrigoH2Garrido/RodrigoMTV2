function initMap(){
    ...
    //var service_url = 'http://18.118.154.162:30100/service/getLocations' // inside the cluster
    var service_url = 'http://192.168.43.169:5000/service/getLocations' // inside the cluster
    ...
    Promise.all([ // esto es para abrir el mapa.
        ...
        if(length(datitos)==0){ // en caso de que no se encuentren puntos -> servicios caidos
            ...
            var boundListener = google.maps.event.addListener((map),'idle',function(event){ // esto permite identificar cuando el mapa esta quieto
                ...
                //var service_url2 = 'http://192.168.0.18:5001/service/getLocations/zoom3/'+zum+'/'+southWest.lat()+'/'+northEast.lat()+'/'+southWest.lng()+'/'+northEast.lng()
                var service_url2 = 'http://192.168.43.169:5000/service/getLocations/zoom3/'+zum+'/'+southWest.lat()+'/'+northEast.lat()+'/'+southWest.lng()+'/'+northEast.lng()
                //var service_url2 = 'http://18.118.154.162:30100/service/getLocations/zoom3/'+zum+'/'+southWest.lat()+'/'+northEast.lat()+'/'+southWest.lng()+'/'+northEast.lng()
                ...
                Promise.all([
                    getPositions1(service_url2).then(function(data){
                        ...
                        console.log('Duración map: ',duration/1000)
    ...
    async function address(map){
        ...
        //var url = 'http://3.133.158.204:32114/service/address1'
        //var url = 'http://192.168.0.18:5001/service/address1'
        //var url = 'http://18.118.154.162:30100/service/address1'
        var url = 'http://192.168.43.169:5000/service/address1'
        ...
        let duration = Date.now() - start
        console.log('duración servicio: ',duration/1000)
    }
...
function setAllOnMap(map,lista){
    for (i = 0; i<lista.length; i++){
        lista[i].setMap(map)
    }
}
