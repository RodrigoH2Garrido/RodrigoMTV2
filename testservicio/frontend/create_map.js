function initMap(){
    //var service_url = 'http://192.168.0.18:5000/service/getLocations' 
    var service_url = 'http://192.168.49.2:30100/service/getLocations' // inside the cluster
    ...
    Promise.all([ // esto es para abrir el mapa.
        ...
        if(length(datitos)==0){ // en caso de que no se encuentren puntos -> servicios caidos
            ...
            var boundListener = google.maps.event.addListener((map),'idle',function(event){ // esto permite identificar cuando el mapa esta quieto
                ...
                //var service_url2 = 'http://192.168.0.18:5000/service/getLocations/zoom3/'+zum+'/'+southWest.lat()+'/'+northEast.lat()+'/'+southWest.lng()+'/'+northEast.lng()
                var service_url2 = 'http://192.168.49.2:30100/service/getLocations/zoom3/'+zum+'/'+southWest.lat()+'/'+northEast.lat()+'/'+southWest.lng()+'/'+northEast.lng()
                //var service_url2 = 'http://3.133.158.204:32114/service/getLocations/zoom3/'+zum+'/'+southWest.lat()+'/'+northEast.lat()+'/'+southWest.lng()+'/'+northEast.lng()
    ...
    async function address(map){
        ...
        //var url = 'http://192.168.0.18:5000/service/address1'
